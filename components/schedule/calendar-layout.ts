...
/**
 * The geometry an event block and the draft ghost share. Clears the hour
 * lines it starts and ends on by a pixel, the same gap it leaves on both
 * inline edges, so the grid shows between blocks.
 */
