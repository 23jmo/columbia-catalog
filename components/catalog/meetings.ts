 ...
 */
export function formatSectionMeetings(section: Pick<SectionListItem, "meetings">): string | null {
...
export function courseInstructors(sections: Pick<SectionListItem, "instructors">[]): string[] {
