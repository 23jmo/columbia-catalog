...
export function llmsTxt(): string {
  return [
    "LionPlan",
    "",
    "LionPlan is a course planner for Columbia College, Columbia Engineering, and Barnard College. Tell it your school, your major, and what you have taken, and it works out what you should take next. A course card shows what a class satisfies and what it unlocks.",
    "",
    "Live schools: Columbia College, Columbia Engineering, and Barnard College. General Studies is coming soon.",
    "",
    "Columbia requirements are read from bulletin.columbia.edu; Barnard requirements are read from Barnard's own catalogue at catalog.barnard.edu, which is a separate publication on its own edition year. Barnard coverage is the Foundations general-education requirements plus eleven majors.",
    "",
