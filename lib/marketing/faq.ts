 ...
 * only: Columbia College, Columbia Engineering and Barnard College.
 * General Studies is coming soon. No user counts. Stellic and Vergil
...
export const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "LionPlan is a course planner for Columbia College, Columbia Engineering, and Barnard College. You tell it your school, major, and what you have taken. It works out what you should take next. A course card shows what a class satisfies and what it unlocks, plus the section time and instructor rating.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "LionPlan is live for Columbia College, Columbia Engineering, and Barnard College. Barnard support covers the Foundations general-education requirements and eleven majors, read from Barnard's own catalogue. General Studies is coming soon. It appears on the school list, but it is not available yet.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A different student project is also called LionPlan. That one is an eight-semester visual planner. This site maps bulletin and catalogue requirements and recommends what to take next for Columbia College, Columbia Engineering, and Barnard College.",
  },
  {
